...
<html lang="en">
  ...
  <body>
    ...
    <div class="tab-container">
	  ...
	  <br>
	  <br>
	  <button onclick="logCommand()">CMD</button>
	  <br>
	  <button onclick="logStart()">SRT</button>
	  <br>
	  <button onclick="logStop()">STP</button>
	  <br>
	  <button onclick="logAddLine()">ADD</button>
